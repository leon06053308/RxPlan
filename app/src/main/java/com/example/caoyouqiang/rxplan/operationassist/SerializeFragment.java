...
public class SerializeFragment extends BaseFragment {
	...
	public SerializeFragment(){

	}

	public static SerializeFragment newInstance() {
		SerializeFragment fragment = new SerializeFragment();
		return fragment;
	}

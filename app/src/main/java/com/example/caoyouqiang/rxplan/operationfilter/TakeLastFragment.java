...
public class TakeLastFragment extends BaseFragment {
	...
	public TakeLastFragment(){

	}

	public static TakeLastFragment newInstance() {
		TakeLastFragment fragment = new TakeLastFragment();
		return fragment;
	}
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		mObservable = Observable.fromArray(arrays).takeLast(2);
